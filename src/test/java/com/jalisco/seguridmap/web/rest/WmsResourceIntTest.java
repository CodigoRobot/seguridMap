...
public class WmsResourceIntTest {
    ...
    public static Wms createEntity(EntityManager em) {
        Wms wms = new Wms()
                ...
                .capa(DEFAULT_CAPA);
        // Add required entity
        Panel panel = PanelResourceIntTest.createEntity(em);
        em.persist(panel);
        em.flush();
        wms.setPanel(panel);
        return wms;
    ...
    public void createWms() throws Exception {
        ...
        assertThat(testWms.getConfiguracion()).isEqualTo(DEFAULT_CONFIGURACION);
    ...
    public void updateWms() throws Exception {
        ...
        assertThat(testWms.getConfiguracion()).isEqualTo(UPDATED_CONFIGURACION);
